...
#let declaration-of-originality() = context {
  ...
  heading-level-1-style[#block()[哈尔滨工程大学本科毕业论文（设计）]]
  ...
  context {
    ...
    text()[
      ...
      本人郑重声明：此处所提交的本科毕业论文（设计）《#title》，是本人在导师指导下，在哈尔滨工程大学攻读学士学位期间独立进行研究工作所取得的成果，且毕业论文（设计）中除已标注引用文献的部分外不包含他人完成或已发表的研究成果。对本毕业论文（设计）的研究工作做出重要贡献的个人和集体，均已在文中以明确方式注明。
  ...
  text(tracking: 0.8pt)[
    ...
    本科毕业论文（设计）是本科生在哈尔滨工程大学攻读学士学位期间完成的成果，知识产权归属哈尔滨工程大学。本科毕业论文（设计）的使用权限如下：

    （1）学校可以采用影印、缩印或其他复制手段保存本科生上交的毕业论文（设计），并向有关部门报送本科毕业论文（设计）；（2）根据需要，学校可以将本科毕业论文（设计）部分或全部内容编入有关数据库进行检索和提供相应阅览服务；（3）本科生毕业后发表与此毕业论文（设计）研究成果相关的学术论文和其他成果时，应征得导师同意，且第一署名单位为哈尔滨工程大学。
